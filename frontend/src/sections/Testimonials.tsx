...
export const TestimonialsSection = () => {
  return <div className="py-16">
    ...
    <div className="container">
      <SectionHeader eyebrow="Happy clients" title="What Clients Say About Me" description="Don't just take my words for it. See what my clients have to say about my work." />
