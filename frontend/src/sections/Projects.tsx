...
export const ProjectsSection = () => {
  return <section className="pb-16 lg:py-24">
    <div className="container">
      ...
      <h2 className="font-serif text-3xl md:text-5xl text-center mt-6">Featerued Projects</h2>
      <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto">See how i transformed concepts into angaging digital experiences</p>

      <div className="flex flex-col md:mt-20 mt-10 gap-20">
        {portfolioProjects.map(project => (
          <div className="bg-gray-800 px-8 pt-8 md:pt-12 md:px-10 lg:pt-16 lg:px-20 rounded-3xl relative z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 after:pointer-events-none" key={project.title} >
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              ...
              <div className="relative">
                <Image src={project.image} alt={project.title} className="mt-8 -mb-4 md:-mb-0 lg:mt-0 lg:absolute lg:w-auto lg:h-full lg:max-w-none" />
              </div>
            </div>
          </div>
        ))}
